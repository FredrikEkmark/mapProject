...
public enum BuildingType {
    ...
    MINE("Mine",
            GameConfig.getBuildingPopulationMaxBonus("MINE"),
            GameConfig.getBuildingManpowerUpkeep("MINE"),
            GameConfig.getBuildingCompleteAtProgress("MINE"),
            GameConfig.getBuildingBuildableElevations("MINE")),
    CARPENTRY("Carpentry",
    ...
    BARRACK("Barrack",
            GameConfig.getBuildingPopulationMaxBonus("BARRACK"),
            GameConfig.getBuildingManpowerUpkeep("BARRACK"),
            GameConfig.getBuildingCompleteAtProgress("BARRACK"),
            GameConfig.getBuildingBuildableElevations("BARRACK")),
    ARCHERY_RANGE("Archery range",
            GameConfig.getBuildingPopulationMaxBonus("ARCHERY_RANGE"),
            GameConfig.getBuildingManpowerUpkeep("ARCHERY_RANGE"),
            GameConfig.getBuildingCompleteAtProgress("ARCHERY_RANGE"),
            GameConfig.getBuildingBuildableElevations("ARCHERY_RANGE")),
    STABLE("Stable",
            GameConfig.getBuildingPopulationMaxBonus("STABLE"),
            GameConfig.getBuildingManpowerUpkeep("STABLE"),
            GameConfig.getBuildingCompleteAtProgress("STABLE"),
            GameConfig.getBuildingBuildableElevations("STABLE")),
    VILLAGE("Village",
