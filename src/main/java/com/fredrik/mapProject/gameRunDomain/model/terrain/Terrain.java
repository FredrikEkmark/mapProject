...
public enum Terrain {
    ...
    COLD_DESERT(Precipitation.LOW, Temperature.SUBARCTIC, Elevation.LOWLANDS),
    COLD_DESERT_HILLS(Precipitation.LOW, Temperature.SUBARCTIC, Elevation.HIGHLANDS),
    ...
    HOT_DESERT(Precipitation.LOW, Temperature.SUBTROPICAL, Elevation.LOWLANDS),
    HOT_DESERT_HILLS(Precipitation.LOW, Temperature.SUBTROPICAL, Elevation.HIGHLANDS),
